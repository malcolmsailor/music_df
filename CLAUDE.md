---
current_as_of_commit: e5d32f7
---

Always use the /music_df skill when working on this repository.

If the user asks you to add to the music_df skill, you can find that at `~/.claude/skills/music_df/`.
